...
function bcr_setup_tables() {
    ...
    $sql = "CREATE TABLE $user_table_name (
        ...
        heightFeet int(9) DEFAULT -1 NOT NULL,
        heightInches int(9) DEFAULT -1 NOT NULL,
        weight int(9) DEFAULT -1 NOT NULL,
...
*/
    ...
    */
    ...
    $sql = "CREATE TABLE $products_table_name (
        ...
        FOREIGN KEY  (categoryID) REFERENCES $categories_table_name(categoryID),
        FOREIGN KEY  (brandID) REFERENCES $brand_table_name(brandID)
        ) $charset_collate;";
